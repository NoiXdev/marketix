            ...
            {enabled && (
                <div className="space-y-3">
                    ...
                    <form onSubmit={disable} className="flex flex-wrap items-end gap-2">
                        ...
                        <button
                            type="submit"
                            className="rounded-md border border-red-300 px-4 py-2 text-sm font-semibold text-red-700 hover:bg-red-50 dark:border-red-800 dark:text-red-400"
                        >
                            Disable
                        </button>
                        <button
                            type="button"
                            onClick={regenerate}
                            className="rounded-md border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300"
                        >
