...
class CheckCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['code' => 'pages_non_crawlable_internal_outlinks', 'category' => 'links', 'severity' => 'warning', 'status' => self::A],
            ['code' => 'pages_high_crawl_depth', 'category' => 'links', 'severity' => 'notice', 'status' => self::A],
            ['code' => 'pages_no_internal_outlinks', 'category' => 'links', 'severity' => 'warning', 'status' => self::A],
            ['code' => 'internal_nofollow_outlinks', 'category' => 'links', 'severity' => 'notice', 'status' => self::A],
            ['code' => 'internal_outlinks_no_anchor', 'category' => 'links', 'severity' => 'notice', 'status' => self::A],
            ['code' => 'non_descriptive_anchor_internal_outlinks', 'category' => 'links', 'severity' => 'notice', 'status' => self::A],
            ['code' => 'pages_many_external_outlinks', 'category' => 'links', 'severity' => 'notice', 'status' => self::A],
            ['code' => 'pages_many_internal_outlinks', 'category' => 'links', 'severity' => 'notice', 'status' => self::A],
            ['code' => 'follow_nofollow_internal_inlinks', 'category' => 'links', 'severity' => 'notice', 'status' => self::A],
            ['code' => 'only_internal_nofollow_inlinks', 'category' => 'links', 'severity' => 'warning', 'status' => self::A],
